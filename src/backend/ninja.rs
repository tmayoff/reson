...
impl Backend for NinjaBackend {
    fn generate(&mut self) {
        ...
        .expect("Failed to write to tmp file");
        writeln!(&mut file, "# Do not edit by hand ").expect("Failed to write to tmp file");
...
impl NinjaBackend {
    ...
    fn generate_scanner_rules(&mut self) {
        ...
        command.push(String::from("depscane"));
    ...
    fn generate_compile_rules_for(&mut self, lang: &String, compiler: &Compiler) {}
